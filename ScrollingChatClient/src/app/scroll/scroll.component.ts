...
import { IFeatureState, getData, getLimitValue, getSkipValue } from './State/posts.reducer';
...
export class ScrollComponent implements OnInit {
  ...
  readonly data$: Observable<IPost[]> = this.store.select(getData);
  ...
  trackByIdFn(_: number, data: IPost): number {
